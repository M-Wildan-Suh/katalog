    ...
    <div class=" w-full bg-[#F1F3F4] min-h-[calc(100vh-370px)] px-4 sm:px-6">
        <div class=" py-12 sm:py-16 w-full max-w-[1080px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class=" w-full aspect-square order-2 md:order-1">
                <iframe loading="lazy" class=" w-full h-full" src="https://maps.google.com/maps?q=Jasawebsite.biz&amp;t=m&amp;z=18&amp;output=embed&amp;iwloc=near" title="Jasawebsite.biz" aria-label="Jasawebsite.biz"></iframe>
            </div>
            <div class="flex flex-col justify-center gap-10 order-1 md:order-2">
                <div style='font-family: "Montserrat", Sans-serif;'
                    class=" w-full text-left text-3xl sm:text-[40px] sm:leading-10 font-bold tracking-tight">
                    <p>Kontak Kami</p>
                </div>
                <div class=" w-full grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div class=" space-y-4">
                        <p class=" text-lg font-semibold uppercase">Alamat</p>
                        <p class=" text-sm leading-7">Komplek Sapta Taruna PU kujangsari blok B1 no 10, KOTA BANDUNG, BANDUNG KIDUL, JAWA BARAT, ID, 40267</p>
                    </div>
                    <div class=" space-y-4">
                    ...
                    <div class=" space-y-4">
                        ...
                        <div class=" flex flex-wrap gap-1 sm:gap-2">
                            <a href="https://www.youtube.com/@jbiztv" target="__blank">
                                <button class=" w-full p-2 aspect-square flex items-center justify-center bg-white hover:bg-green-200 hover:text-green-600 duration-300 rounded-md">
                                    <div class=" w-7 h-7">
