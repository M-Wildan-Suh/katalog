        ...
        <div class="w-full sm:h-screen px-4 sm:px-6 relative overflow-hidden">
            ...
            <div class=" pt-32 sm:pt-20 flex flex-col justify-end w-full h-full max-w-[960px] mx-auto relative">
                <div class="space-y-4">
                    ...
                    <p class=" text-center text-sm sm:text-base text-neutral-600">Punya usaha tapi belum punya website? Tinggal pilih desain favoritmu, kami yang sesuaikan dengan bisnismu.
                        Praktis, cepat, dan terima beres!</p>
