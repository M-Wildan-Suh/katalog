                ...
                <div style="background-image: url('https://katalog.jasawebsite.biz/wp-content/uploads/2024/07/kataloog-bg.jpg')" class=" bg-center bg-cover w-full aspect-[3/1] sm:aspect-[4/1]  rounded-md overflow-hidden relative">
                    ...
                    <div class=" w-full h-full relative">
                        <div class=" flex items-center justify-center text-center w-full h-full p-4 text-white relative">
                            <p class=" text-sm sm:text-2xl font-bold">Pilih desain kesukaan kamu yg bisa kamu edit mandiri dipandu dengan video tutorial yang kami siapkan. Difasilitasi login ke admin dan video panduan editnya.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=" md:col-span-3 w-full space-y-4 sm:space-y-6">
                        <div class=" w-full flex justify-between items-center">
                            <div class=" w-full flex items-center gap-2 sm:gap-4">
                                ...
                                <p class=" text-xl sm:text-3xl font-bold text-center">Desain Terbaru</p>
                            </div>
                    ...
                    <div class="">
                        <div class=" md:sticky top-24 space-y-4 sm:space-y-6">
                            <div class=" w-full flex items-center gap-2 sm:gap-4 h-7 sm:h-10">
                                ...
                                <p class=" text-xl font-bold text-center">Desain Populer</p>
                            </div>
