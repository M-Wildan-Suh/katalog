                    ...
                    <div class=" w-full grid grid-cols-1 sm:grid-cols-3 gap-6 ">
                        <div class=" w-full p-4 rounded-md overflow-hidden bg-white border shadow-md shadow-black/20">
                            <div class=" space-y-2 sm:space-y-4">
                                ...
                                <h2 class=" text-xl sm:text-2xl font-bold">Mudah Kelola</h2>
                                <p class=" text-xs sm:text-sm text-neutral-600">Website berbasis WordPress Admin sehingga kamu bisa dengan mudah mengubah teks, gambar, maupun konten.</p>
                            </div>
                        </div>
                        <div class=" w-full p-4 rounded-md overflow-hidden bg-white border shadow-md shadow-black/20">
                            <div class=" space-y-2 sm:space-y-4">
                                ...
                                <p class=" text-xs sm:text-sm text-neutral-600">Tampilan mengikuti tren terbaru, membuat usahamu lebih kredibel dan menarik.</p>
                            </div>
                        </div>
                        <div class=" w-full p-4 rounded-md overflow-hidden bg-white border shadow-md shadow-black/20">
                            <div class=" space-y-2 sm:space-y-4">
                                ...
                                <h2 class=" text-xl sm:text-2xl font-bold">Siap Online</h2>
                                <p class=" text-xs sm:text-sm text-neutral-600">Website langsung bisa digunakan, dengan desain yang responsif dan nyaman diakses dari semua perangkat.</p>
                            </div>
                        </div>
