<x-app-layout head="Create Package" title="Admin - Create Package">
    <div class="sm:pl-12 sm:pr-12 lg:pr-32 duration-300 pt-8 pb-20 sm:pb-8 px-4 space-y-4">
        <form action="{{ route('package.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="w-full p-4 sm:p-8 bg-white rounded-md shadow-md shadow-black/20 flex flex-col gap-6">
                <x-admin.component.textinput title="Nama Paket" placeholder="Masukkan nama paket..." :value="old('title')"
                    name="title" />
                <x-admin.component.priceinput title="Harga" placeholder="Masukkan harga..." :value="old('price')"
                    name="price" />
                <div x-data="{ items: [] }" class="w-full">
                ...
                <x-admin.component.linkinput title="Video (Link Youtube) (Optional)" placeholder="Masukkan link..."
                    value="{{ old('video') }}" name="video" link="Url" />
