    ...
    <div class="sm:pl-12 sm:pr-12 lg:pr-32 duration-300 pt-8 pb-20 sm:pb-8 px-4 space-y-6">
        <div class=" w-full sm:py-4 p-4 sm:p-6 bg-white rounded-md shadow-md shadow-black/20">
            <div class=" flex items-center justify-between">
                ...
                <a href="{{ route('article-page.show', ['article' => $article->id]) }}" class=" text-sm sm:text-base text-byolink-1 hover:text-byolink-3 duration-300 text-nowrap" target="__blank">Edit Spintax</a>
            </div>
        </div>
        <div class="w-full p-4 sm:p-8 bg-white rounded-md shadow-md shadow-black/20 flex flex-col gap-6">
                ...
                <div class=" w-full sm:w-auto flex justify-between gap-4 sm:justify-start">
                    <div class=" flex flex-row items-center gap-1">
                        <div class=" relative group w-4 sm:w-5 aspect-square text-red-500">
                            <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><g><path d="M24 0a24 24 0 1 0 24 24A24 24 0 0 0 24 0Zm0 46a22 22 0 1 1 22-22 22 22 0 0 1-22 22Z" fill="currentColor"></path><path d="M24 6a18 18 0 1 0 18 18A18 18 0 0 0 24 6Zm1 33.95V35h-2v4.95A16 16 0 0 1 8.05 25H14v-2H8.05A16 16 0 0 1 23 8.05V13h2V8.05A16 16 0 0 1 39.95 23H34v2h5.95A16 16 0 0 1 25 39.95Z" fill="currentColor"></path><path d="M25 17h-2v7a1 1 0 0 0 .29.71l6 6 1.41-1.41-5.7-5.71Z" fill="currentColor"></path></g></svg>
                        </div>
            ...
            <table class="w-full max-w-full text-sm sm:text-base rounded-md">
                ...
                @forelse ($data as $item)
                    <tr class="{{ $item->status === 'schedule' ? 'bg-red-100' : ($item->status === 'publish' ? 'bg-green-100' : 'bg-purple-100') }} h-10 text-neutral-600 divide-x-2 divide-white">
