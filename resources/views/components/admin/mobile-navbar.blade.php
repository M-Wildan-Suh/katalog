<div x-data="{ isOpen: false }" class=" flex sm:hidden">
    <div class=" fixed bottom-4 left-0 w-full px-4 z-40">
        <div
            class=" w-full rounded-full bg-white shadow-md shadow-black/20 py-2 px-3 text-xs grid grid-cols-3 border border-neutral-300">
            <a href="{{ route('dashboard') }}"
                class=" flex flex-col items-center text-byolink-1 hover:text-byolink-3 duration-300">
                <button class=" w-6 aspect-square">
                    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            data-name="world www web website" fill="currentColor" class="fill-000000"></path>
                    </svg>
                </button>
                <p>Dashboard</p>
            </a>
            <div class=" flex justify-center relative">
                <button @click="isOpen = !isOpen" class=" aspect-square rounded-full duration-300 text-white p-1.5"
                    ...
                    <svg viewBox="0 0 32 32" class=" w-auto h-auto" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <div class=" grid grid-cols-2 p-4 gap-4 text-sm">
            ...
            <div x-data="{ dropdown: false }" class=" relative">
                ...
                <div x-show="dropdown" class=" bg-white rounded-md flex flex-col absolute top-1/2 -translate-y-1/2 left-full ml-2 py-2 z-20 border">
                    <a href="{{route('banner.index')}}" class=" w-full px-4">Banner</a>
                    <a href="{{route('package.index')}}" class=" w-full px-4">Paket</a>
                    <a href="{{route('portfolio.index')}}" class=" w-full px-4">Portofolio</a>
                    <a href="{{route('gallery.index')}}" class=" w-full px-4">Galeri</a>
                    <a href="{{route('leadcall.index')}}" class=" w-full px-4">Leadcall</a>
                </div>
            </div>
            <x-admin.mobile-navbutton route="category.index" :active="['category.index', 'category.create', 'category.show']">
                <x-slot:svg>
