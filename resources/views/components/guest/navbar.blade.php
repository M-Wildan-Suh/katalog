...
<div class="" x-data="{ open: false }">
    <div class=" fixed top-0 left-0 grid grid-col-3 w-full bg-white px-4 md:px-8 py-4 z-40 shadow-md shadow-black/10">
        <div class=" w-full max-w-[1080px] mx-auto flex items-center gap-10 justify-between">
                ...
                <form action="{{ route('allarticle') }}" method="get">
                    <div class=" flex items-center justify-between h-10 bg-white">
                        ...
                        <button aria-label="Cari"
                            class=" px-4 sm:px-6 bg-byolink-1 hover:bg-byolink-3 rounded-r-full text-white duration-300 h-10">
            ...
            <button @click="open = !open" :class="{ 'text-third': open, 'text-second': !open }" aria-label="Menu"
                class=" flex md:hidden gap-2 items-center duration-300">
                <div class=" w-6 h-6">
