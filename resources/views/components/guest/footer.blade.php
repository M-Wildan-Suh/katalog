        ...
        <div class=" w-full px-4 md:px-8 py-4">
            <div class=" w-full max-w-[1080px] mx-auto grid grid-cols-3 gap-4 sm:gap-6 text-white">
                <div class=" col-span-3 md:col-span-1 space-y-6">
                    <div class=" space-y-2">
                        <div class=" h-10 sm:h-12 flex items-start overflow-hidden">
                            <p class=" text-xl sm:text-3xl font-bold text-white">WebMandiri</p>
                            {{-- <img src="{{asset('assets/images/logo.png')}}" alt=""> --}}
                        </div>
                        <p class=" text-xs sm:text-sm">Pilih desain kesukaanmu yg bisa kamu edit mandiri dipandu video tutorial yang kami siapkan. Dengan fasilitasi login ke halaman admin.</p>
                    </div>
                    ...
                    <div class=" flex flex-col gap-2">
                        <div class=" flex items-center gap-2">
                            ...
                            <a href="https://wa.me/{{$hp}}" target="__blank">
                                <p class=" hover:underline">{{ '+62 ' . substr($hp, 3, 3) . '-' . substr($hp, 6, 4) . '-' . substr($hp, 10) }}</p>
                            </a>
                        </div>
                        <div class=" flex items-center gap-2">
                            <div class=" min-w-4 w-4 aspect-square text-main">
                        ...
                        <div class=" flex items-center gap-2">
                            ...
                            <a href="https://maps.app.goo.gl/J1eVkmTBPpgw52JH6" target="__blank">
                                <p class=" hover:underline">Komplek Sapta Taruna PU kujangsari blok B1 no 10, KOTA BANDUNG, BANDUNG KIDUL, JAWA BARAT, ID, 40267</p>
                            </a>
                        </div>
                    </div>
                </div>
