            ...
            <div class=" w-full max-w-[1080px] mx-auto grid grid-cols-3 gap-4 sm:gap-6 text-white">
                <div class=" col-span-3 md:col-span-1 space-y-6">
                    <div class=" space-y-2">
                        ...
                        <p class=" text-xs sm:text-sm">Pilih desain kesukaanmu yg bisa kamu edit mandiri dipandu dengan video tutorial yang kami siapkan. Dengan fasilitasi login ke halaman admin.</p>
                    </div>
                    ...
                    <div class=" flex flex-col gap-2">
                        <div class=" flex items-center gap-2">
                            ...
                            <a href="https://wa.me/+6285798765798" target="__blank">
                                <p class="hover:underline">+62 857-9876-5798</p>
                            </a>
                        </div>
                        <div class=" flex items-center gap-2">
                            <div class=" min-w-4 w-4 aspect-square text-main">
