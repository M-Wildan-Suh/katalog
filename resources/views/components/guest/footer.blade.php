                ...
                <div class=" col-span-3 md:col-span-1 space-y-6">
                    <div class=" space-y-2">
                        <div class=" h-10 sm:h-12 flex items-start overflow-hidden">
                            <p class=" text-3xl sm:text-4xl font-bold text-white">WebMandiri</p>
                            {{-- <img src="{{asset('assets/images/logo.png')}}" alt=""> --}}
                        </div>
                        <p class=" text-sm">Pilih desain kesukaanmu yg bisa kamu edit mandiri dipandu dengan video tutorial yang kami siapkan. Dengan fasilitasi login ke halaman admin.</p>
                    </div>
                    <div class=" space-y-4">
