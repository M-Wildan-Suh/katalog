...
<div class=" w-full max-w-[600px] mx-auto space-y-4">
    <div style="background-color: {{ $template->desc_main_color ?? 'white' }}; color: {{ $template->desc_text_color }}" class=" w-auto p-4 text-base sm:text-xl font-bold rounded-md shadow-md">Video Tutorial</div>
