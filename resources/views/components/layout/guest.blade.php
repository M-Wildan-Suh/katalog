...
<head>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-TN8RZLB7');
    </script>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=DynaPuff:wdth,wght@75..100,400..700&family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
...
<body class=" font-montserrat antialiased" x-data="{ loading: true }" x-init="setTimeout(() => loading = false, 1000)"
    @beforeunload.window="loading = true" @load.window="setTimeout(() => loading = false, 1000)"
    @pageshow.window="loading = false">

    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TN8RZLB7" height="0" width="0"
            style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->

    <!-- Loading overlay -->
    <div x-show="loading" class="fixed inset-0 z-[200] flex items-center justify-center bg-white"
